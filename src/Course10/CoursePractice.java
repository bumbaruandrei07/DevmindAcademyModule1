...
public class CoursePractice {
    /*
     Implementeaza o metoda (i.e. countOccurrencesIgnoreCase(String[] array, String key))
      care determina numarul de elemente key din cadrul array si returneaza aceasta valoare.
